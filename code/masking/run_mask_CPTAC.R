...
params$file=paste0('results/cptac_k=',params$k,'_alpha',params$alpha,'_lambda',params$lambda,'_eta',params$eta,'_percmask',perc_mask,'_mask',params$mask,'_ninit',ninit,'.RData')
...
load("CPTAC_gencode_filtered.RData")
X=XCPTAC
y = rep(0,ncol(X))
delta = rep(0,ncol(X))
Train=list()
